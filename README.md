...
<p align="center">
  <strong>Research Preview 0.2.0</strong> · latest reviewed repository release: v0.2.4 · 6 focused modules + 1 optional All-in-One
</p>
...
- Release record: [v0.2.4](docs/releases/v0.2.4.md)
- Previous release record: [v0.2.3](docs/releases/v0.2.3.md)
