...
<p align="center"><strong>Research Preview 0.2.0</strong> · dernière version du dépôt validée : v0.2.4 · 6 modules spécialisés + 1 All-in-One facultatif</p>
...
- Dernière version du dépôt validée : `v0.2.4`
- `v0.2.3` : correction du contrat d’installation à invocation explicite pour Codex et Claude Code
- `v0.2.4` : validation plus stricte de la politique Codex et détection des versions dans les commits de fusion
