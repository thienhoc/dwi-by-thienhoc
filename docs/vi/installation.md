...
Mô-đun Dwi là kỹ năng dạng văn bản cho tác nhân AI. `SKILL.md` là file hành vi duy nhất bắt buộc. Không có dịch vụ cài đặt, tiến trình chạy nền, gói chạy Dwi riêng, máy chủ kết nối công cụ hoặc phụ thuộc website. Vẫn cần một lớp công cụ tác nhân lập trình được hỗ trợ.
...
Không chuyển thẳng một lệnh tải từ mạng vào trình dòng lệnh nếu chưa đọc nội dung.
