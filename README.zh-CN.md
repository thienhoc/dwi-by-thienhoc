...
<p align="center"><strong>Research Preview 0.2.0</strong> · 最新已审核仓库版本：v0.2.4 · 6 个专用模块 + 1 个可选 All-in-One</p>
...
- 最新已审核仓库版本：`v0.2.4`
- `v0.2.3`：修复 Codex 与 Claude Code 的仅显式调用安装契约
- `v0.2.4`：加强 Codex 策略验证和合并提交中的发布检测
