...
<h1 align="center">AI đi nhanh. Bạn vẫn rõ đường.</h1>

<p align="center">
  Sáu kỹ năng tác nhân AI độc lập cho Codex và Claude Code, giúp phạm vi rõ, công việc có giới hạn và bằng chứng luôn nhìn thấy được.
</p>
...
Lớp công cụ gốc, tức ứng dụng hoặc công cụ dòng lệnh chạy tác nhân AI và kiểm soát quyền dùng công cụ, thường giỏi thực hiện công việc. Dwi tập trung vào lớp con người xung quanh công việc đó: người dùng thực sự muốn gì, tác nhân AI được phép sửa gì, mức nỗ lực nào là vừa đủ, ai được quyền ghi và bằng chứng nào hỗ trợ kết quả.

Dwi không thay thế lớp công cụ gốc. Đây là một bộ kỹ năng cho tác nhân AI, mỗi kỹ năng là một thư mục hướng dẫn có thể cài riêng và gỡ bằng cách xóa đúng một thư mục.
...
| Nhiều tác nhân cần làm chung có cấu trúc | [Dwi • Arc](docs/vi/modules/arc.md) | Chia thành ô công việc có giới hạn, mỗi phạm vi chỉ có một tác nhân được ghi |
...
4. Gọi kỹ năng một cách rõ ràng rồi so sánh với cách làm thường ngày.
...
Dwi tách rõ `ĐÃ XÁC MINH`, `ĐÃ QUAN SÁT`, `ƯỚC TÍNH`, `MỤC TIÊU` và `CHƯA BIẾT`. Số liệu từ một lần thử không được biến thành lời hứa cho mọi người. Checklist công khai yêu cầu nguồn có thể kiểm tra bên cạnh mọi con số dùng để quảng bá.
...
```text
modules/                 Các kỹ năng có thể cài độc lập
